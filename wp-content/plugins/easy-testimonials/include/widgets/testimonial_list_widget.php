...
class listTestimonialsWidget extends WP_Widget
{
					...
					<legend>Show Rating:</legend> &nbsp;
						<div class="bikeshed bikeshed_radio">
							<div class="radio_wrapper">
								...
								<p class="radio_option"><label><input class="tog" name="<?php echo esc_html( $this->get_field_name('show_rating') ); ?>" type="radio" value="none" <?php if($show_rating=='none'){ ?>checked="checked"<?php } ?> > Do Not Show</label></p>
							</div>
						</div>						
						<br />
	...
	function widget($args, $instance){
		...
		$easy_testimonials->outputTestimonials( $args );
