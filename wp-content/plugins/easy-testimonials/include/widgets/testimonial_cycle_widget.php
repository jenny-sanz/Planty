...
{	
	...
	function form($instance){
		...
		<div class="gp_widget_form_wrapper">
			...
			<fieldset class="radio_text_input">
				...
				<div class="bikeshed_radio">
					...
					<p>
						...
						<select id="<?php echo esc_attr( $this->get_field_id('order_by') ); ?>" name="<?php echo esc_attr( $this->get_field_name('order_by') ); ?>" class="multi_left">
			...
			<fieldset class="radio_text_input">
				...
				<div class="bikeshed_radio">
					<p>
						<label for="<?php echo esc_attr( $this->get_field_id('testimonials_per_slide') ); ?>">Testimonials Per Slide:</label>
						<input class="widefat" id="<?php echo esc_attr( $this->get_field_id('testimonials_per_slide') ); ?>" name="<?php echo esc_attr( $this->get_field_name('testimonials_per_slide') ); ?>" type="text" value="<?php echo esc_attr($testimonials_per_slide); ?>" />				
					</p>
					
					<p>
						<label for="<?php echo esc_attr( $this->get_field_id('transition') ); ?>">Transition:</label><br/>
					...
					<p>
						<label for="<?php echo esc_attr( $this->get_field_id('timer') ); ?>">Timer:</label>
						<input class="widefat" id="<?php echo esc_attr( $this->get_field_id('timer') ); ?>" name="<?php echo esc_attr( $this->get_field_name('timer') ); ?>" type="text" value="<?php echo esc_attr($timer); ?>" />
					</p>
					<p class="description">The time between transitions.  Please Note: 1000 = 1 second.</p>
					<p>
						<input name="<?php echo esc_attr( $this->get_field_name('pause_on_hover') ); ?>" type="hidden" value="0" />
						<input class="widefat" id="<?php echo esc_attr( $this->get_field_id('pause_on_hover') ); ?>" name="<?php echo esc_attr( $this->get_field_name('pause_on_hover') ); ?>" type="checkbox" value="true" <?php if($pause_on_hover){ ?>checked="CHECKED"<?php } ?> data-shortcode-value-if-unchecked="0" />
						<label for="<?php echo esc_attr( $this->get_field_id('pause_on_hover') ); ?>">Pause on Hover</label>
					</p>
					<p>
						<input name="<?php echo esc_attr( $this->get_field_name('auto_height') ); ?>" type="hidden" value="calc" />
						<input class="widefat" data-shortcode-value-if-unchecked="calc" id="<?php echo esc_attr( $this->get_field_id('auto_height') ); ?>" name="<?php echo esc_attr( $this->get_field_name('auto_height') ); ?>" type="checkbox" value="container" <?php if($auto_height == "container"){ ?>checked="CHECKED"<?php } ?> data-shortcode-value-if-unchecked="calc" />
						<label for="<?php echo esc_attr( $this->get_field_id('auto_height') ); ?>">Auto Height</label>
						<br/>
					</p>	
					...
					<p>
						<input name="<?php echo esc_attr( $this->get_field_name('show_pager_icons') ); ?>" type="hidden" value="0" />
						<input class="widefat" id="<?php echo esc_attr( $this->get_field_id('show_pager_icons') ); ?>" name="<?php echo esc_attr( $this->get_field_name('show_pager_icons') ); ?>" type="checkbox" value="1" <?php if($show_pager_icons){ ?>checked="CHECKED"<?php } ?> data-shortcode-value-if-unchecked="0" />
						<label for="<?php echo esc_attr( $this->get_field_id('show_pager_icons') ); ?>">Show Pager Icons</label>
					</p>	
					<p>
						<input name="<?php echo esc_attr( $this->get_field_name('prev_next') ); ?>" type="hidden" value="0" />
						<input class="widefat" id="<?php echo esc_attr( $this->get_field_id('prev_next') ); ?>" name="<?php echo esc_attr( $this->get_field_name('prev_next') ); ?>" type="checkbox" value="1" <?php if($prev_next){ ?>checked="CHECKED"<?php } ?> data-shortcode-value-if-unchecked="0" />
						<label for="<?php echo esc_attr( $this->get_field_id('prev_next') ); ?>">Show Previous and Next Buttons</label>
					</p>
					<p>
						<input name="<?php echo esc_attr( $this->get_field_name('display_pagers_above') ); ?>" type="hidden" value="0" />
						<input class="widefat" id="<?php echo esc_attr( $this->get_field_id('display_pagers_above') ); ?>" name="<?php echo esc_attr( $this->get_field_name('display_pagers_above') ); ?>" type="checkbox" value="1" <?php if($display_pagers_above){ ?>checked="CHECKED"<?php } ?> data-shortcode-value-if-unchecked="0" />
						<label for="<?php echo esc_attr( $this->get_field_id('display_pagers_above') ); ?>">Position Pagers Above Testimonial</label>
					</p>
					...
					<p>
						<input name="<?php echo esc_attr( $this->get_field_name('paused') ); ?>" type="hidden" value="0" />
						<input class="widefat" id="<?php echo esc_attr( $this->get_field_id('paused') ); ?>" name="<?php echo esc_attr( $this->get_field_name('paused') ); ?>" type="checkbox" value="1" <?php if($paused){ ?>checked="CHECKED"<?php } ?> data-shortcode-value-if-unchecked="0" />
	...
	function widget($args, $instance){
		...
		$easy_testimonials->outputTestimonialsCycle( $args );
