...
class TestimonialsGridWidget extends WP_Widget
{
	...
	function form($instance) {
		...
		<div class="gp_widget_form_wrapper">
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id('cols') ); ?>">Number Of Columns: </label><br />				
				...
				<?php foreach(range(1, 10) as $iCol): ?>
					...
					<?php printf( '<option value="%d" %s>%d</option>', esc_attr($iCol), esc_html($sel_attr), esc_html($iCol) ); ?>
				<?php endforeach; ?>
				</select>
				<br/>
			</p>
			...
			<fieldset class="radio_text_input">
				...
				<div class="bikeshed bikeshed_radio">
					<p>
						<label for="<?php echo esc_attr( $this->get_field_id('grid_width') ); ?>">Width of the Grid: </label><br />
						<input class="widefat" id="<?php echo esc_attr( $this->get_field_id('grid_width') ); ?>" name="<?php echo esc_attr( $this->get_field_name('grid_width') ); ?>" type="text" value="<?php echo esc_attr($grid_width); ?>" /></label>
						<br/>
						<em>e.g. 100px or 25%. Leave blank to use the default width.</em>
					</p>

					<p>
						<label for="<?php echo esc_attr( $this->get_field_id('cell_width') ); ?>">Width of Each Cell: </label><br />
						<input class="widefat" id="<?php echo esc_attr( $this->get_field_id('cell_width') ); ?>" name="<?php echo esc_attr( $this->get_field_name('cell_width') ); ?>" type="text" value="<?php echo esc_attr($cell_width); ?>" /></label>
						<br/>
						<em>e.g. 100px or 25%. Leave blank to use the default width.</em>
					</p>
				
					<p>
						<label for="<?php echo esc_attr( $this->get_field_id('grid_spacing') ); ?>">Spacing between each cell:</label><br />
						<input class="widefat" id="<?php echo esc_attr( $this->get_field_id('grid_spacing') ); ?>" name="<?php echo esc_attr( $this->get_field_name('grid_spacing') ); ?>" type="text" value="<?php echo esc_attr($grid_spacing); ?>" /></label>
						<br/>
					...
					<p>
						<label for="<?php echo esc_attr( $this->get_field_id('grid_class') ); ?>">CSS classes: </label><br />
						<input class="widefat" id="<?php echo esc_attr( $this->get_field_id('grid_class') ); ?>" name="<?php echo esc_attr( $this->get_field_name('grid_class') ); ?>" type="text" value="<?php echo esc_attr($grid_class); ?>" /></label>
						<br/>
						<em>Extra CSS classes to be applied to this grid.</em>
					</p>

					<p>
						<input name="<?php echo esc_attr( $this->get_field_name('responsive') ); ?>" type="hidden" value="0" />
						<input class="widefat" id="<?php echo esc_attr( $this->get_field_id('responsive') ); ?>" name="<?php echo esc_attr( $this->get_field_name('responsive') ); ?>" type="checkbox" value="1" <?php if($responsive){ ?>checked="CHECKED"<?php } ?> data-shortcode-value-if-unchecked="0" />
						<label for="<?php echo esc_attr( $this->get_field_id('responsive') ); ?>">Responsive</label>
					</p>

					<p>
						<input name="<?php echo esc_attr( $this->get_field_name('equal_height_rows') ); ?>" type="hidden" value="0" />
						<input class="widefat" id="<?php echo esc_attr( $this->get_field_id('equal_height_rows') ); ?>" name="<?php echo esc_attr( $this->get_field_name('equal_height_rows') ); ?>" type="checkbox" value="1" <?php if($equal_height_rows){ ?>checked="CHECKED"<?php } ?> data-shortcode-value-if-unchecked="0" />
						<label for="<?php echo esc_attr( $this->get_field_id('equal_height_rows') ); ?>">Make testimonials in each row the same height</label>
					</p>
				</div>
			</fieldset>
			...
			<fieldset class="radio_text_input">
				...
				<div class="bikeshed bikeshed_radio">
					<p>
						<label>
							<input type="radio" name="<?php echo esc_attr( $this->get_field_name('paginate') ); ?>" value="all" class="tog" <?php echo ($paginate == 'all' ? 'checked="checked"' : '');?>>All On One Page
						</label>
						<br/>
					...
					<p>
						<label>
							<input type="radio" name="<?php echo esc_attr( $this->get_field_name('paginate') ); ?>" value="max" class="tog" <?php echo ($paginate == 'max' ? 'checked="checked"' : '');?>>Max Per Page: 
						</label>
						<input type="text" name="<?php echo esc_attr( $this->get_field_name('testimonials_per_page') ); ?>" id="<?php echo esc_attr( $this->get_field_id('testimonials_per_page') ); ?>" class="small-text" value="<?php echo esc_attr($testimonials_per_page); ?>">
						<br/>
						<em>Pagination links will be displayed with this many testimonials shown per page.</em>
					</p>
					<p>
						<label>
							<input type="radio" name="<?php echo esc_attr( $this->get_field_name('paginate') ); ?>" value="0" class="tog" <?php echo ($paginate == false ? 'checked="checked"' : '');?>>Specific Amount: 
						</label>
						<input type="text" name="<?php echo esc_attr( $this->get_field_name('count') ); ?>" id="<?php echo esc_attr( $this->get_field_id('count') ); ?>" class="small-text" value="<?php echo esc_attr($count); ?>">
						<br/>
			...
			<fieldset class="radio_text_input">
				...
				<div class="bikeshed_radio">
					...
					<p>
						...
						<label for="<?php echo esc_attr( $this->get_field_id('reveal_full_content') ); ?>">Click To Reveal Text</label>
					</p>	
	...
	function widget($args, $instance){
		...
		echo wp_kses_post( $easy_testimonials->easy_t_testimonials_grid_shortcode( $args ) );
