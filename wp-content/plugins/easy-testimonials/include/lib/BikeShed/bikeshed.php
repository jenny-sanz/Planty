		...
		?>
				<tr valign="top">
					<th scope="row">
						...
						<label <?php echo (!empty($label_for) ? 'for="' . esc_attr($label_for) . '"' : '');?>><?php echo esc_html_e( esc_html($label) );?></label>
						<?php elseif (!empty($label) && $plain_label):?>
						<?php esc_html_e( esc_html($label) );?>
						<?php else: ?>
						&nbsp;
						<?php endif; ?>
					</th>
			...
			<div class="bikeshed bikeshed_checkbox">
				<div class="checkbox_wrapper">
					<label for="<?php echo esc_attr($field_name); ?>">
						<input type="checkbox" value="<?php echo esc_html($options['value']); ?>" name="<?php echo esc_attr($field_name); ?>" id="<?php echo esc_attr($field_id); ?>" <?php echo ($options['checked'] ? 'checked="checked"' : ''); ?> <?php echo ($options['disabled'] ? 'disabled="disabled"' : ''); ?>>
			...
			<div class="bikeshed bikeshed_radio">
				<div class="radio_wrapper">
					...
					<p class="radio_option">
						...
						<?php echo esc_html($inline_input); ?>
					</p>
					<?php endforeach; ?>				
				</div>
				<?php if(!empty($options['description'])): ?>
				<p class="description"><?php esc_html_e($options['description']);?></p>
				<?php endif; ?>				
			</div>
<?php
			$this->end_row();
...
?>	
			<div class="bikeshed bikeshed_text">
				<div class="text_wrapper">
					...
					?>
					<input type="text" name="<?php echo esc_attr($field_name); ?>" id="<?php echo esc_attr($field_id); ?>" value="<?php echo esc_attr($options['value']); ?>" <?php echo esc_html($class_attr); ?> <?php echo ($options['disabled'] ? 'disabled="disabled"' : ''); ?> />
				</div>
				<?php if(!empty($options['description'])): ?>
				<p class="description"><?php esc_html_e($options['description']);?></p>
				<?php endif; ?>				
			...
			<div class="bikeshed bikeshed_select">
				<div class="select_wrapper">
					<select name="<?php echo esc_attr($select_name); ?>" id="<?php echo esc_attr($select_id); ?>" <?php echo ($options['disabled'] ? 'disabled="disabled"' : ''); ?>>	
						<?php foreach($options['options'] as $value => $name): ?>
						<option value="<?php echo esc_attr($value); ?>" <?php if($options['value'] == $value): echo 'selected="selected"'; endif; ?>><?php echo esc_html($name); ?></option>
						<?php endforeach; ?>
					</select>
				</div>
				<?php if(!empty($options['description'])): ?>
...
?>	
			<div class="bikeshed bikeshed_typography">
				<div class="select_wrapper font_size_select_wrapper">
					<select name="<?php echo esc_attr($font_size_name); ?>" id="<?php echo esc_attr($font_size_id); ?>" class="font_size_select" <?php echo esc_html($disabled_attr); ?>>
						...
						<option value="<?php echo esc_attr($font_size); ?>" <?php echo esc_html($selected); ?>><?php echo esc_html($font_size); ?>px</option>
						<?php endforeach; ?>
					</select>
				</div>
				<div class="select_wrapper font_family_select_wrapper">
					<select name="<?php echo esc_attr($font_family_name); ?>" id="<?php echo esc_attr($font_family_id); ?>" class="font_family_select" <?php echo esc_html($disabled_attr); ?>>
						...
						<?php endif; ?>
							...
							<option value="<?=esc_attr($family)?>" <?=esc_attr($selected)?>><?=esc_attr($family)?></option>
							<?php endforeach; ?>
						<?php if($options['google_fonts']): ?>
						</optgroup>
						<?php endif; ?>
						...
						<optgroup label="Google Fonts">
							...
							<option value="google:<?=esc_attr($family)?>" <?=esc_attr($selected)?>><?=esc_attr($family)?></option>
							<?php endforeach; ?>
						</optgroup>
						<?php endif; ?>
					</select>
				...
				<div class="select_wrapper font_style_select_wrapper">
					<select name="<?php echo esc_attr($font_style_name); ?>" id="<?php echo esc_attr($font_style_id); ?>" class="font_style_select" <?php echo esc_html($disabled_attr); ?>>
						...
						<option value="<?=esc_attr($style)?>" <?=esc_attr($selected)?>><?=esc_attr($style)?></option>
						<?php endforeach; ?>
					</select>
				</div>
				<div class="color_picker_wrapper">
					<?php if (empty($options['default_color'])): ?>
					<input type="text" name="<?php echo esc_attr($font_color_name); ?>" id="<?php echo esc_attr($font_color_id); ?>" class="wp-color-picker" value="<?php echo esc_attr($values['font_color']); ?>" <?php echo esc_html($disabled_attr); ?> />
					<?php else: ?>
					<input data-default-color="<?php echo esc_attr($options['default_color']); ?>" type="text" name="<?php echo esc_attr($font_color_name); ?>" id="<?php echo esc_attr($font_color_id); ?>" class="wp-color-picker" value="<?php echo esc_attr($values['font_color']); ?>" <?php echo esc_html($disabled_attr); ?> />
					<?php endif; ?>
				</div>
				<?php if(!empty($options['description'])): ?>
				<p class="description"><?php echo esc_html($options['description']);?></p>
