...
/* La fonction wpb_admin_menu prend deux arguments : $items (les éléments du menu de navigation )et $args (tableau associatif contenant les options theme_location; l'id du menu; etc)*/
...
// Le filtre "wp_nav_menu_items" permet de filtrer les éléments de menu générés par wp_nav_menu
